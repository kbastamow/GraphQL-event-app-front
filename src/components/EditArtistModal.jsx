  ...
  return (
    <>
      <div className="d-flex justify-content-end">
        ...
        >
          <div className="d-flex align-items-center">Edit Artist</div>
        </button>
      </div>

      <div className="modal fade" id="editArtistModal" aria-labelledby="editArtistModalLabel" aria-hidden="true">
                    ...
                    <div className="d-flex flex-wrap">
                      {genres &&
                        genres.map((genre) => (
                          ...
                          >
                            {genre.name}{" "}
                            <span onClick={() => setGenres(genres.filter((item) => item.id !== genre.id))}>
                              <BsFillTrash3Fill />
                            </span>
                          </span>
                        ))}
                    ...
                    <ul className="list-unstyled">
                      {data?.genres?.map((genre) => (
                        <li
                          ...
                          onClick={() => setGenres([...genres, { id: genre.id, name: genre.name }])}
                        >
                          {genre.name}
                        </li>
                      ))}
